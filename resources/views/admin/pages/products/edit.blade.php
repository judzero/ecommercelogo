                    ...
                    <div class="card-body">
                        <form action="{{route('adminpanel.products.edit', $product->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control @error('title') is-valid @enderror" value="{{$product->title}}">
                                @error('title')
                                ...
                                <input type="number" name="price" id="price" class="form-control @error('price') is-valid @enderror" value="{{$product->price / 100}}">
                                @error('price')
                                <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                                </span>
